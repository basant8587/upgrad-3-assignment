...
public class LabRequestController {
    ...
    public List<TestRequest> getForTests()  {
        ...
        //Make use of the findBy() method from  class to get the list
    ...
    public List<TestRequest> getForTester()  {
        ...
        return testRequestQueryService.findByTester(tester); // replace this line with your code
    ...
    public TestRequest assignForLabTest(@PathVariable Long id) {
        ...
        try {
            ...
            return testRequestUpdateService.assignForLabTest(id,tester) ; // replace this line of code with your implementation
