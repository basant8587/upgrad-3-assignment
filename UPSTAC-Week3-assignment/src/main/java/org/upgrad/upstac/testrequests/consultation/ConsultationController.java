...
public class ConsultationController {
    ...
    public List<TestRequest> getForDoctor()  {
        ...
        return testRequestQueryService.findByDoctor(doctor); // replace this line with your code
    ...
    public TestRequest assignForConsultation(@PathVariable Long id) {
        ...
        User doctor = userLoggedInService.getLoggedInUser();
        try {
            return testRequestUpdateService.assignForConsultation(id,doctor); // replace this line of code with your implementation
    ...
    public TestRequest updateConsultation(@PathVariable Long id,@RequestBody CreateConsultationRequest testResult) {
        ...
        User doctor = userLoggedInService.getLoggedInUser();
        try {
            return testRequestUpdateService.updateConsultation(id,testResult,doctor); // replace this line of code with your implementation
